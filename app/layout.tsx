  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        ...
        <div className="bg-[#a9a0e6] absolute top-[54rem] -z-10 left-[-36rem] h-[61.25rem] w-[61rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] md:top-[-1rem] md:h-[31.25rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-[#676394]"></div>
